...
Summary(pl):	System dºwiÍku YIFF
Name:		yiff
Version:	2.12.3
...
%description -l pl
Serwer dºwiÍku YIFF jest zgodnym z Y serwerem dºwiÍku daj±cym obs≥ugÍ
dºwiÍku dla aplikacji klienckich zgodnych z Y. Uøywa sterownikÛw OSS
lub ALSA.
...
Pliki potrzebne do tworzenia programÛw uøywaj±cych systemu dºwiÍku
YIFF.
...
Biblioteki potrzebne do uruchamiania programÛw korzystaj±cych z
systemu dºwiÍku YIFF.

%package config
Summary:	YIFF configuration utility
Summary(pl):	NarzÍdzie konfiguracyjne do YIFF
...
NarzÍdzie konfiguracyjne do systemu dºwiÍku YIFF.
